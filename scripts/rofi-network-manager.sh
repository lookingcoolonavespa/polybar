...
function initialization() {
	...
	{ [[ -f "$DIR/rofi/networkmenu.rasi" ]] && RASI_DIR="$DIR/rofi/networkmenu.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/rofi/rofi-network-manager.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/rofi-network-manager.rasi"; } || exit
